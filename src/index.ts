...
import { detectKind, ocrByKind } from './services/ocr/ocr-by-kind.js';
import {
  DefaultOcrProcessor,
  type OcrProcessor,
} from './services/ocr/ocr-processor.js';
import {
  aiExtract,
  extractBlNo,
  DefaultAiExtractor,
  type AiExtractor,
} from './services/ai/ai-extractor.js';
import { uploadToEb } from './services/upload/upload-to-eb.js';
